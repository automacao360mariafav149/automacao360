...
const Footer = () => {
  return (
    <footer className="bg-brand-dark-blue text-gray-400 py-12 px-4 sm:px-6 lg:px-8">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
        {/* Coluna 1: Logo e Descrição */}
        <div className="lg:col-span-2 flex flex-col space-y-4">
          <h3 className="text-3xl font-bold text-orange-500">Automação360</h3>
          ...
          <div className="space-y-2">
            <div className="flex items-center space-x-2">
              ...
              <a href="https://wa.me/5511999999999" target="_blank" rel="noopener noreferrer" className="hover:text-orange-400 transition-colors">+55 (11) 99999-9999</a>
            </div>
            <div className="flex items-center space-x-2">
              <Mail className="w-5 h-5 text-orange-500" />
              <a href="mailto:contato@automacao360.com.br" className="hover:text-orange-400 transition-colors">contato@automacao360.com.br</a>
            </div>
            <div className="flex items-center space-x-2">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><a href="/#solucoes" className="hover:text-orange-400 transition-colors">Soluções</a></li>
            <li><a href="/#integracoes" className="hover:text-orange-400 transition-colors">Integrações</a></li>
            <li><a href="/#precos" className="hover:text-orange-400 transition-colors">Preços</a></li>
            <li><a href="/#diferenciais" className="hover:text-orange-400 transition-colors">Diferenciais</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><a href="https://wa.me/5511999999999" target="_blank" rel="noopener noreferrer" className="hover:text-orange-400 transition-colors">Contato (WhatsApp)</a></li>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><a href="/politica-de-privacidade" className="hover:text-orange-400 transition-colors">Política de Privacidade</a></li>
          </ul>
        </div>
      </div>
      ...
      <div className="border-t border-gray-700 mt-12 pt-8 text-center text-gray-500 text-sm">
        ...
        <div className="flex items-center justify-center space-x-6 mt-4 text-green-500">
